...
public class IntJoukkoTest {
    ...
    public void vainLisatytLuvutLoytyvat() {
        assertTrue(joukko.alkioOnJoukossa(10));
        assertFalse(joukko.alkioOnJoukossa(5));
        assertTrue(joukko.alkioOnJoukossa(3));
    }

    @Test
    public void poistettuEiOleEnaaJoukossa() {
        joukko.poista(3);
        assertFalse(joukko.alkioOnJoukossa(3));
    ...
    public void toimiiKasvatuksenJalkeen(){
        ...
        assertTrue(joukko.alkioOnJoukossa(11));
        joukko.poista(11);
        assertFalse(joukko.alkioOnJoukossa(11));
