...
public class KassapaateTest {
    ...
    @Test
    public void kortilleLisataanRahaaJosLadattavaSummaPositiivinen(){
    ...
    @Test
    public void kortilleEiTapahduMitaanJosLadattavaSummaNegatiivinen(){
        kassa.lataa(kortti, -5);
        
        verify(kortti, never()).lataa(anyInt());
    }
}
